...
ActiveRecord::Schema.define(version: 2023_03_16_113316) do
  ...
  create_table "purchase_record_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
